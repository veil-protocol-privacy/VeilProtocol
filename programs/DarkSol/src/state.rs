...
pub fn initialize_commitments(
    ...
    let mut manager_account_required_lamports = manager_account_rent.minimum_balance(manager_account_space);
...
pub fn initialize_commitments_account(
    ...
    let mut manager_data: CommitmentsManagerAccount = CommitmentsManagerAccount::try_from_slice(&data)?;
